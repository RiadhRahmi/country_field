...
/**
* Plugin implementation of the 'country_field' field type.
*
* @FieldType(
*   id = "country_field",
...
* )
*/
class CountryFieldItem extends FieldItemBase implements FieldItemInterface {
    ...
    public function isEmpty() {
        return empty($this->get('country')->getValue());
    }
